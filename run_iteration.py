...
Z_init = 0.02                 # give the initial Z here. Values between 0.02 and 0.008
Z_text = str(Z_init/0.02)

import fileinput
for i in [100, 200]:          # give the initial masses here.

    j = str(i)
    for line in fileinput.FileInput("inlist_project_LOGS",inplace=1):
        ...
        if sline[0].startswith("initial_mass"):
            ...
            logs = '/Users/gauthamsabhahit/Documents/mesa-r12115/VMS_paper1/MODELS/LOGS_'+j+'_'+Z_text+'Z_sol'
            sline[1]="'"+logs+"'"
        line='='.join(sline)    
        print(line)
